...
<body>
	<!-- start add -->
	<div id="addDialog" icon="icon-save" class="easyui-dialog" title="添加记录" style="width: 380px; height: 200px;" buttons="#dlg-buttons" resizable="true"
		closed="true">
		<br /> <br />
		<form:form modelAttribute="addForm" action="" method="post">
			...
			<table style="float: center">
				<tr>
					<td><label>角色 <input type="text" name="name" id="name" value="" class="easyui-validatebox text" required="true" /></td>
					</label>
				</tr>
				<tr>
					<td><label>角色名称 <input type="text" name="alias" id="alias" value="" class="easyui-validatebox text" required="true" /></td>
					</label>
				</tr>
				<tr>
					<td><label>描述 <input type="text" name="desc" id="desc" value="" class="text" /></td>
					</label>
				</tr>
			</table>
		</form:form>
