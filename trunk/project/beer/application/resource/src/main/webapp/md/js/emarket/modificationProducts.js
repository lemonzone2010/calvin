...
function controlButtonDisplay(){
	 var stateString=$("#addProductPublicationForm\\:stateString").val();
	if(stateString.length>0){
	  $("#buttonPublished").hide();
	}else{
	  $("#buttonPublishedModfiy").hide();
	}
}
...
var flg=true;
  function submitFunction(obj){
		...
		var retailPriceId=document.getElementById("addProductPublicationForm:retailPriceId").value;
		var wholesalePriceId=document.getElementById("addProductPublicationForm:wholesalePriceId").value;
