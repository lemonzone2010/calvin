...
public class ValidationUtilsTest {
	...
	public void invokeValidator(){
		...
		ValidationReport validationReport =
			ValidationUtils.invokeValidator(new MockUserNameValidator(), "name", user);
	...
	public void invokeValidatorFailed(){
		DummyUser user = new DummyUser();
		ValidationReport validationReport =
			ValidationUtils.invokeValidator(new MockUserNameValidator(), "noExistName", user);
		assertEquals("SmartOrg-Err-001", validationReport.getCode());
	}
	...
	public void invokeValidatorNullPointerException(){
		DummyUser user = new DummyUser();
		ValidationReport validationReport =
			ValidationUtils.invokeValidator(new MockUserNameValidator(), "role.roleName", user);
