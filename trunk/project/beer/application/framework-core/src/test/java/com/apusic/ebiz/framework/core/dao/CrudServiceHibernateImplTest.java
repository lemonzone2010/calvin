...
public class CrudServiceHibernateImplTest {
	...
	public void createPermission() {
		...
		boolean isAttached = ((Session) crudService.getDelegate())
				.contains(detachedPermission);
		...
		// But become attached
		isAttached = ((Session) crudService.getDelegate())
				.contains(detachedPermission);
	...
	public void createUserWithExistingRole() {
		...
		DummyRole existingRole = crudService.retrieve(DummyRole.class, 22);
