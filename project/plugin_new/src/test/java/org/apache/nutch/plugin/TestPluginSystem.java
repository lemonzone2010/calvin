...
import com.xia.plugin.Configuration;
...
public class TestPluginSystem extends TestCase {
    ...
    protected void setUp() throws Exception {
       ...
       // String string = this.conf.get("plugin.includes", "");
        ...
        conf.set("plugin.folders", "plugin,");
        fPluginCount = 5;
   ...
   /* public void testRepositoryCache() {
	...
	-->
<plugin id="org.apache.nutch.plugin.1" name="1" version="1.0"
	provider-name="joa23" class="org.apache.nutch.plugin.SimpleTestPlugin">
	<extension-point id="aExtensioID" name="simple Parser Extension"
		schema="schema/testExtensionPoint.exsd" />
	<runtime>
		<library name="libs/exported.jar">
			<extport />
		</library>
		<library name="libs/not_exported.jar" />
	</runtime>
	<extension point="aExtensioID">
		<implementation name="simple Parser Extension" id="aExtensionId."
    ...
    public static void main(String[] args) throws IOException {
        new TestPluginSystem().createPluginManifest(1, "d:/");
    }
