                ...
                (
                    {
                        ...
                        {
                            $( this )
                                .attr( 'title', '/admin/ping 没有配置 (' + xhr.status + ': ' + error_thrown + ')' );
                ...
                (
                    {
                        ...
                        {
                            this
                                .html( '<div class="loader">正在加载 ...</div>' );
                        },
                        success : function( response, text_status, xhr )
                        {
                ...
                success : function( response )
                {
                    ...
                    for( var core_name in response.status )
                    {
                        ...
                        var core_tpl = '<li id="' + core_name + '" data-basepath="' + core_path + '">' + "\n"
                                     ...
                                     + '        <li class="schema"><a href="#/' + core_name + '/schema"><span>模板</span></a></li>' + "\n"
                                     + '        <li class="config"><a href="#/' + core_name + '/config"><span>配置</span></a></li>' + "\n"
                                     + '        <li class="replication"><a href="#/' + core_name + '/replication"><span>复制</span></a></li>' + "\n"
                                     + '        <li class="analysis"><a href="#/' + core_name + '/analysis"><span>分析</span></a></li>' + "\n"
                                     + '        <li class="schema-browser"><a href="#/' + core_name + '/schema-browser"><span>查看模板</span></a></li>' + "\n"
                                     + '        <li class="plugins"><a href="#/' + core_name + '/plugins"><span>插件管理</span></a></li>' + "\n"
                                     + '        <li class="dataimport"><a href="#/' + core_name + '/dataimport"><span>数据导入</span></a></li>' + "\n"
